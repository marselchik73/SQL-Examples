...
Проект с примерами SQL-запросов для окна бронирования (имя, email, телефон, кнопка «Забронировать»).
...
Выполните внутри MySQL после подключения:
...
mysql -u root -p booking_db
 ...
 5. Затем выполните (внутри MySQL) любой запрос из списка выше, например:
